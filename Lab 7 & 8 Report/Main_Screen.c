...
void update_LCD_color(char direction, char color)
{
	...
	if (color == Color_Red) //if Color red make red circles red but leave outline
    {
	...
	if (color == Color_Yellow) //if Color yellow make yellow circle yellow but leave outline
    {
        fillCircle(XRED, Circle_Y, Circle_Size, ST7735_BLACK);
    ...
    if (color == Color_Green) //if Color green make green circle green but leave outline
    {
        fillCircle(XRED, Circle_Y, Circle_Size, ST7735_BLACK);
        fillCircle(XYEL, Circle_Y, Circle_Size, ST7735_BLACK);
