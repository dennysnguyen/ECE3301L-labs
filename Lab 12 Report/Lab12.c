...
//    char duty_cycle = 100;
    ...
    while(1)
    {
        ...
        {
            tempSecond = second;
            signed char DS1621_tempC = DS1621_Read_Temp();
            signed char DS1621_tempF = (DS1621_tempC * 9 / 5) + 32;
            int rpm = get_RPM();
        ...
        if (Nec_OK == 1)
        {
            ...
            //part C lab 12
            else if (Nec_Button == 0xC2)
            {
                Toggle_Fan();
            }
            else if (Nec_Button == 0xE0)
            {
                Decrease_Speed();
            }
            else if (Nec_Button == 0xA8)
            {
                Increase_Speed();
            }
